...
int main()
{
    ...
    init_pwm_irq();
    int enter_first_state_result = 0;
    ...
    for (;;)
    {
        ...
        // {
        //     case ENTER_DAYS:
        //         // if (key_event != 0 && (key_char != '#' && key_char != '*' && key_char != 'A' && key_char != 'B' && key_char != 'C' && key_char != 'D') ) {
        //         // start_new_blink_sequence(); // Ensure the timer pattern updates immediately on the first press
        ...
        //         // }
        //         // else if ((key_char != '#' && key_char != '*' && key_char != 'A' && key_char != 'B' && key_char != 'C' && key_char != 'D'))
        //         // {
        //         //     start_new_blink_sequence();
        //         // }
